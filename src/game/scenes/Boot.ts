...
export class Boot extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('shipPart1', 'assets/shipParts/part1.png');
        this.load.image('shipPart2', 'assets/shipParts/part2.png');
        this.load.image('shipPart3', 'assets/shipParts/part3.png');
